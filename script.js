$(document).ready(function(){
    ...
    $('.galImg .point_three a').click(function(e){
        e.preventDefault();
        if($('.galImg .galim4').attr('src') != $(this).attr('href')){
            $('.galImg .galim4').hide().attr('src', $(this).attr('href')).fadeIn(1000).css({
                width: '100%',
                height: '100%',
            })
        }
    ...
    $('.galImg .point_three a img').mouseup(function (){
        $(this).fadeTo(2000, 0.6);
    });
    $(document).mouseup(function (){
        $('.galImg .point_three a img').fadeTo(0, 1);
    })
